...
i < 12; ++i)
components.
insert(std::make_unique<ComponentDescription>(std::vector<VirtualType::Type>{VirtualType::virtualBool})
);
...
std::cout << "Running test with " << components.

size()

+ 1 << " components and " << allSets.
...
std::cout << smallResult1 << " nanoseconds to find " << smallSet1.
...
std::cout << smallResult2 << " nanoseconds to find " << smallSet2.
...
std::cout << smallResult3 << " nanoseconds to find " << smallSet3.
...
std::cout << "average: " << average << " nanoseconds" <<
std::endl;
printCallsPerFrame(average,
144);
printCallsPerFrame(average,
120);
printCallsPerFrame(average,
...
std::cout << medResult1 << " nanoseconds to find " << medSet1.
...
std::cout << medResult2 << " nanoseconds to find " << medSet2.
...
std::cout << medResult3 << " nanoseconds to find " << medSet3.
...
{
std::cout << "Query with " << components.
...
std::cout << largeResult << " nanoseconds to find " << set.

archetypeCount()

<< " archetypes\n";
printCallsPerFrame(largeResult,
144);
printCallsPerFrame(largeResult,
120);
printCallsPerFrame(largeResult,
