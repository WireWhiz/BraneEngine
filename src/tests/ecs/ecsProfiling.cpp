...
TEST(ECS_Profiling, QueryCreation_WorstCase)
{
    ...
    {
        em.components().registerComponent(c.get());
    ...
    std::cout << "Running test with " << components.size() + 1 << " components and " << allSets.size() << " archetypes" << std::endl;
    ...
    SystemContext ctx;
    {
        ...
        std::cout << smallResult1 << " nanoseconds to find " << smallSet1.archetypeCount() << " archetypes (EntityID, this is absolute worst case)\n";
        ...
        std::cout << smallResult2 << " nanoseconds to find " << smallSet2.archetypeCount() << " archetypes\n";
        ...
        std::cout << smallResult3 << " nanoseconds to find " << smallSet3.archetypeCount() << " archetypes\n";
    ...
    }
    {
        ...
        std::cout << medResult1 << " nanoseconds to find " << medSet1.archetypeCount() << " archetypes\n";
        ...
        std::cout << medResult2 << " nanoseconds to find " << medSet2.archetypeCount() << " archetypes\n";
        ...
        std::cout << medResult3 << " nanoseconds to find " << medSet3.archetypeCount() << " archetypes\n";
...

    {
        ...
        std::cout << largeResult << " nanoseconds to find " << set.archetypeCount() << " archetypes\n";
...
TEST(ECS_Profiling, QueryCreation_PlausableCase)
{
    ...
    std::cout << "Running test with " << components.size() + 1 << " components and " << randomSets.size() << " archetypes" << std::endl;
    ...
    SystemContext ctx;
    {
        ...
        auto smallSet1 = em.getEntities(smallFilter1);
        auto smallResult1 = smallTime1.time<std::chrono::nanoseconds>();
        std::cout << smallResult1 << " nanoseconds to find " << smallSet1.archetypeCount() << " archetypes\n";
