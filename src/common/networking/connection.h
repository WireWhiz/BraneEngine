...
namespace net {
    ...
    protected:
        ...
        robin_hood::unordered_map <uint32_t, std::function<void(ResponseCode code,
                                                                InputSerializer s)>> _responseListeners;
        IMessage _tempIn;
    ...
    protected:
        ...
        void async_writeBody(size_t chunkIndex = 0) {
            ...
            asio::async_write(
                    _socket,
                    asio::buffer(_obuffer.front().chunks[chunkIndex].data(),
                                 _obuffer.front().chunks[chunkIndex].size()),
